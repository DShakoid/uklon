...
<g>
	<path class="st0" d="M8.5,3.7c-1.1,0.5-2,1.1-2.8,1.9S4.2,7.4,3.7,8.5C3.2,9.6,3,10.8,3,12c0,1.4,0.3,2.7,0.9,3.9
		...
		c-0.5-1.1-1.1-2-1.9-2.8c-0.8-0.8-1.8-1.4-2.9-1.9C14.4,3.2,13.2,3,12,3S9.6,3.2,8.5,3.7z"/>
	<polygon class="st0" points="11,7 11,12.4 14.8,16.2 16.2,14.8 13,11.6 13,7 	"/>
</g>
</svg>
					   Поїздки
            </button>
